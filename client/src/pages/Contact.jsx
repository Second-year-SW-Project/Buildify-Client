...
import { useChatbot } from "../User/ChatbotContext";
  ...
  const contactMethods = [
    {
      ...
      description:
        "If you have any issues with your computer order, please contact one of our customer service specialists.",
    ...
    },
    {
      ...
      description:
        "If you have any technical issues with your computer, please contact one of our technicians.",
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/10">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Come see our latest builds and get hands-on assistance from our
                experts.
              </p>
            </div>
                ...
                <div className="absolute top-16 left-2 bg-gradient-to-br from-purple-600 to-purple-800 text-white p-6 rounded-2xl max-w-xs shadow-xl border border-purple-400/30">
                  {locationInfo.map((location, index) => (
                    <div
                      ...
                      className={
                        index > 0
                          ? "mt-4 pt-4 border-t border-purple-400/30"
                          : ""
                      }
                    >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-purple-500/10 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20">
                ...
                <p className="text-gray-300">
                  Support:{" "}
                  <a
                    href="mailto:support@buildify.com"
                    className="text-purple-400 hover:text-purple-300 transition-colors"
                  >
