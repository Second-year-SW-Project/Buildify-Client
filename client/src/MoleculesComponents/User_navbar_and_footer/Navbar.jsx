  ...
  return (
    ...
    <nav className="w-full h-[175px] bg-[#1a1c1e] text-white flex flex-col items-center relative z-50">
      ...
      <div className="w-full max-w-[1350px] flex justify-around text-sm font-medium pb-[10px] space-x-6 sm:space-x-4">
        ...
        <Link to="/laptop" className="hover:text-blue-400">Laptops</Link>
        ...
        <div className="relative dropdown-container">
          ...
          {openDropdown === "components" && (
            <div className="absolute left-0 w-40 bg-[#333] text-white rounded-md shadow-lg mt-1 flex flex-col py-2">
              <Link to="/productcategorypage/gpu" className="block px-4 py-2 hover:bg-blue-400">Graphic Cards</Link>
              <Link to="/productcategorypage/ram" className="block px-4 py-2 hover:bg-blue-400">RAM</Link>
              <Link to="/productcategorypage/processor" className="block px-4 py-2 hover:bg-blue-400">Processors</Link>
            </div>
          )}
        </div>
