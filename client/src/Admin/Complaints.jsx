...
<Box className="mb-10 border-2 border-black-200 rounded-md mt-6">
      ...
      >
        ...
        <DialogContent className="p-6 space-y-6 max-h-[70vh] overflow-y-auto scrollbar-thin 
        scrollbar-thumb-purple-300 scrollbar-track-purple-100 rounded-2xl">
          {selectedComplaint && (
            <>
              {/* User Info Card */}

              <div className="bg-gradient-to-br from-purple-50 via-purple-100 to-white p-5 rounded-2xl border
               border-purple-300 shadow-sm transition-transform hover:scale-[1.01] mt-6">
