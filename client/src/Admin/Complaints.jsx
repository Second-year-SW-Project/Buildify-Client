    ...
    <div className="p-6 h-screen ">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className='mt-3 mb-5'>
            <PageTitle value="Complaint Management" />
            <CustomBreadcrumbs
              paths={[
...
<div className="flex gap-4 mb-6 items-center flex-wrap ml-4">
  <TextField
    placeholder="Search"
    className="w-full sm:w-80 md:w-96 lg:w-200"  // Responsive width for different screen sizes
    value={searchTerm}
  ...
  />
  <FormControl className="w-full sm:w-48 md:w-60 lg:w-90">  {/* Adjusts width based on screen size */}
